    ...
    >
      ...
      <q-list>
        <q-item clickable v-ripple to="/" exact>
          ...
          <q-item-section class="text-h6 text-weigt-bold">Home</q-item-section>
        </q-item>
      </q-list>
      <q-list>
        <q-item clickable v-ripple to="/about" exact>
          ...
          <q-item-section class="text-h6 text-weigt-bold">About</q-item-section>
        </q-item>
      </q-list>
    </q-drawer>
